...
void SSD1306::rotate_display(uint8_t rotate)
{
	...
	this->send_command(0xA0 | (0x01 & rotate));  // Set Segment Re-Map Default
							// 0xA0 (0x00) => column Address 0 mapped to 127
                			// 0xA1 (0x01) => Column Address 127 mapped to 0

	this->send_command(0xC0 | (0x08 & (rotate<<3)));  // Set COM Output Scan Direction
